...
function draw() {
  ...
  if(score == 100){
    ...
    fill("black");
    textSize(40);
    text("You protected your planet from asteroids.",canvas.width/2-350,canvas.height/2);
  ...
  if(gameState === instruction) {
    ...
    text("ENJOY THE GAME!",canvas.width/2-300,canvas.height/2+140);
    stroke("yellow");
    fill("yellow");
    textSize(35);
    ...
    text("  press 's' to start game.",canvas.width/2,canvas.height/2+50);
    text("  shoot 100 asteroids to protect your planet.",canvas.width/2-200,canvas.height-350);
